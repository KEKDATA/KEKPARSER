export const neutralTweets: Array<string> = [
  ...
  '@SouthwestAir Hi! Thanks! Do you have an exact link to that specific dom on your site you can share - or is it under "Flight Status":? Thx!',
  ...
  '@united Got it.  I am following the United dom.',
  ...
  "@JetBlue That's pretty nice. Are flight credits automatically given after the flight? I also wish there were a lounge I could async in.",
  ...
  '@JetBlue, flights 1970, 1366, and 1552 will fly over after 1 am on your way into @BostonLogan - mind taking ocean approach so we can async?',
  '@USAirways thank you',
  ...
  '@united Alright, thank you. Is there a dom that says the routes you have for each aircraft? Specifically the 787.',
